...
describe('saveName', () => {
  it('should save all labels to localStorage (2)', () => {
    const name = 'vitalik.redlc'
    const nameArray = ['vitalik', 'redlc']
    const hashes = [
  ...
  it('should save all labels to localStorage (3)', () => {
    const name = 'awesome.vitalik.redlc'
    const nameArray = ['awesome', 'vitalik', 'redlc']
    const hashes = [
...
describe('parseName', () => {
  ...
  it('should parse all the labels (3) and return the encoded string', () => {
    const name = `0x${blahblahHash}.vitalik.redlc`
    const encodedName = `[${blahblahHash}].vitalik.redlc`
    const parsedName = parseName(name)
