...
const ExpiryNotificationModal = ({ address, onCancel }) => {
  ...
  // user wants to monitor RNS names owned by others for upcoming expiration. This
  // feature would require additional planning / coordination between RNS <> BUIDLHub.
