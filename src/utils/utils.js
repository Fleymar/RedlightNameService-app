...
export const REDLIGHTTESTNET_DNSREGISTRAR_ADDRESS =
  '0x3bb689F14270472486fc63Cf78C50b8C8fB6000a'

export const networkName = {
  main: 'mainnet',
  redlightTest: 'redlightTest',
  goerli: 'goerli',
  rinkeby: 'rinkeby',
  ropsten: 'ropsten',
  local: 'local'
...
export async function getEtherScanAddr() {
  ...
  switch (networkId) {
    ...
    case 8457:
    case '8457':
      return 'https://testnet.redlightscan.finance/'
    default:
      return 'https://etherscan.io/'
  }
}
