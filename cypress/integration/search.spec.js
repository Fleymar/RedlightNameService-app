...
describe(
  ...
  () => {
    ...
    it('can see the list of Names if no TLDS are specified', () => {
      ...
      cy.queryByText('notldispsecified.redlc', { exact: false }).should('exist')
    })
    ...
    it('should uri encode search term', () => {
      ...
      cy.wait(10000)
      cy.queryByText(
        'Domain malformed. %e2%80%8btest.redlc is not a valid domain.',
        {
          exact: false
        }
      ).should('exist')
